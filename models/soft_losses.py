...
# import sys
# sys.path.append('D:\MTSC\softclt-main')
...
def hier_CL_soft(z1, z2,z_overlap, soft_labels, tau_temp=2, lambda_=0.5, temporal_unit=0,
            ...
            if 1 - lambda_ != 0:
                if soft_temporal:
                    if temporal_hierarchy:
                        timelag = timelag_cosine(z_overlap,tau_temp*(2**d))
                    else:
